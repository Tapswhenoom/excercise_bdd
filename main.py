...
from temperature_control_unit.TemperatureControlUnit import (
    TemperatureControlUnit, temp_decay)
from states_enum.States import States_SCU
...
if __name__ == '__main__':
    ...
    # shutdown_button = threading.Thread(
    #     target=coffee_machine.shutdown_button_pressed, daemon=True)
    # shutdown_button.start()
    water_decay_thread = threading.Thread(target=temp_decay, args=(tcu,),
                                          daemon=True)
